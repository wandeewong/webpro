        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                    ...
                    <div class="panel panel-primary" style="margin-top: 20px;">
                        <div class="panel-heading">สินค้าลดราคา</div>
                        <div class="panel-body">
                            <div style="margin: 20px;" class="text-center">
                                <div class="btn-group">
                                    <a href="promotion.php?mode=h-s" class="btn btn-primary">จากราคามากมาน้อย</a>
                                    <a href="promotion.php?mode=hot" class="btn btn-primary">ยอดนิยม</a>
                                    <a href="promotion.php?mode=s-h" class="btn btn-primary">จากราคาน้อยมามาก</a>
                                </div>
                            </div>
                            <?php
                            if($mode == 'h-s')
